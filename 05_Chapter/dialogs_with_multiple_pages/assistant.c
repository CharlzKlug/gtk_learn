...
int main(int argc, char *argv[]) {
  ...
  /* Create the necessary widgets for the fourth page. Attach the progress bar
...
static void entry_changed(GtkEditable *entry,
 ...
 * stop the user from progressing the next page. */
static void button_toggled(GtkCheckButton *toggle,
			   GtkAssistant *assistant) {
